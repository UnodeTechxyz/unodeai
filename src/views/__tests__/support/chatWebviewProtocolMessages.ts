export const validWebviewMessages: Record<string, Record<string, unknown>> = {
  ...
  setCodexPermissionProfile: { command: 'setCodexPermissionProfile', agentId: 'agent-1', profile: 'approve-for-me' },
...
export const malformedWebviewMessages: Record<string, Record<string, unknown>> = {
  ...
  setCodexPermissionProfile: { ...validWebviewMessages.setCodexPermissionProfile, profile: 'future-root' },
...
export const overlongWebviewIdentityMessages: Array<[string, Record<string, unknown>]> = [
  ...
  ['setCodexPermissionProfile.agentId', { ...validWebviewMessages.setCodexPermissionProfile, agentId: tooLong(160) }],
