...
const MUTATIONS = [
  ...
  },
  {
    ...
    // v0.9.79 made this confirmation a centred modal, so both sides carry the options argument. The mutant still
    // disconnects the projection; only the surrounding call changed.
    from: '      void vscode.window.showInformationMessage(runEvidenceExportConfirmation(run), { modal: true });',
    to: "      void vscode.window.showInformationMessage('Exported complete run evidence pack.', { modal: true });",
  },
  {
