...
single child process; it never writes the user's global Git configuration. This lets an agent prove a local
source snapshot such as `Roam Crew v0.9.8` even though ordinary source searches deliberately skip `.git`.
